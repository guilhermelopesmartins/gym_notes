...
class ExerciseLogService extends ChangeNotifier {
  ...
  List<ExerciseLogWithDetails> _exerciseLogsWithDetail = [];
  String? _currentTrainingBlockId;
  String? _currentExerciseId;

  List<ExerciseLog> get exerciseLogs => _exerciseLogs;
  List<ExerciseLogWithDetails> get exerciseLogsWithDetail => _exerciseLogsWithDetail;
  ...
  Future<void> fetchExerciseLogs({
    ...
    try {
      ...
      _exerciseLogs = (json.decode(response.body) as List)
          ...
          .toList();
      if (detail == true) {
        _exerciseLogsWithDetail = (json.decode(response.body) as List)
            .map((json) => ExerciseLogWithDetails.fromJson(json as Map<String, dynamic>))
            .toList();
      }
      notifyListeners();
    } catch (e) {
