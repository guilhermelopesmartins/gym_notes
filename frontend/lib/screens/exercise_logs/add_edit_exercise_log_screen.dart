...
class _AddEditExerciseLogScreenState extends State<AddEditExerciseLogScreen> {
  ...
  void _copyExerciseSet(int index) {
    ...
    setState(() {
      ...
      _unitControllers.add(TextEditingController(text: 'kg')); 
      _rpeControllers.add(TextEditingController(text: rpe.toString()));
      _setNotesControllers.add(TextEditingController());
    });
  }
    ...
    if (_formKey.currentState!.validate()) {
      ...
      for (int i = 0; i < _setControllers.length; i++) {
        ...
        if (setNum == null || reps == null || weight == null) {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Por favor, preencha todos os campos obrigatórios (Série, Repetições, Peso) para a Série ${i + 1}.')),
            );
          }
          return;
        }
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Row( // This new Row groups your icons together
                  mainAxisSize: MainAxisSize.min, // Makes sure this Row only takes up space needed by its children
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => _copyExerciseSet(index),
                    ),
                  ],
                ),
              ],
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'Notas da Séries (Opcional)',
                      border: OutlineInputBorder(),
                      isDense: true,
                    ),
                    keyboardType: TextInputType.text,
